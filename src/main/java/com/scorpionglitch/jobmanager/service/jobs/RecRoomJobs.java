...
@Service
@Configurable
public class RecRoomJobs {
	private static final String NAME = "RecRoom";

	private static final String GREENHOUSE_BOARD_ID = "recroom";
	private static final Logger LOGGER = LoggerFactory.getLogger(RecRoomJobs.class);
	private static final String[] LOCATIONS = {"Remote (United States)"};
