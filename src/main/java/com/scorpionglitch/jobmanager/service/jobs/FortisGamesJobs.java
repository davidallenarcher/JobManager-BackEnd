...
@Service
@Configurable
public class FortisGamesJobs {
	private static final String NAME = "Fortis Games";

	private static final String GREENHOUSE_BOARD_ID = "fortisgames";
	private static final Logger LOGGER = LoggerFactory.getLogger(FortisGamesJobs.class);
	private static final String[] LOCATIONS = {"Remote - Americas", "Remote - Global", "Remote - United States"};
