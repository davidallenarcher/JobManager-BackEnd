...
@Service
@Configurable
public class NCSoftJobs {
	private static final String NAME = "NCSoft";

	private static final String GREENHOUSE_BOARD_ID = "ncsoftwest";
	private static final Logger LOGGER = LoggerFactory.getLogger(NCSoftJobs.class);
	private static final String[] LOCATIONS = {"United States", "Bellevue, WA or Remote "};
