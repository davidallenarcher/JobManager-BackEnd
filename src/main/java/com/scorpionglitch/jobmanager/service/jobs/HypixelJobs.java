...
@Service
@Configurable
public class HypixelJobs {
	private static final String NAME = "Hypixel";

	private static final String GREENHOUSE_BOARD_ID = "hypixelstudios";
	private static final Logger LOGGER = LoggerFactory.getLogger(HypixelJobs.class);
	private static final String[] LOCATIONS = {	"Remote/ In-Office"};
