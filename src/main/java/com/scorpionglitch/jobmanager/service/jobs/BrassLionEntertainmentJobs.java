...
@Service
@Configurable
public class BrassLionEntertainmentJobs {
	private static final String NAME = "Brass Lion Entertainment";

	private static final String GREENHOUSE_BOARD_ID = "brasslionentertainment";
	private static final Logger LOGGER = LoggerFactory.getLogger(BrassLionEntertainmentJobs.class);
	private static final String[] LOCATIONS = {"Montreal, New York, US/CAN Remote"};
