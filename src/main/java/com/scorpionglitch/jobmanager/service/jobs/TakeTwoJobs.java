...
public class TakeTwoJobs {
	...
	private static final String GREENHOUSE_BOARD_ID = "taketwo";
	private static final Logger LOGGER = LoggerFactory.getLogger(TakeTwoJobs.class);
	private static final String[] LOCATIONS = {"New York, New York, United States", "United States, Remote", "New York"};
