...
@Service
@Configurable
public class BadRobotJobs {
	private static final String NAME = "BadRobot";

	private static final String GREENHOUSE_BOARD_ID = "badrobotgames";
	private static final Logger LOGGER = LoggerFactory.getLogger(BadRobotJobs.class);
	private static final String[] LOCATIONS = {"Remote"};
