...
@Service
@Configurable
public class ThatGameCompanyJobs {
	private static final String NAME = "thatgamecompany";

	private static final String GREENHOUSE_BOARD_ID = "thatgamecompany";
	private static final Logger LOGGER = LoggerFactory.getLogger(ThatGameCompanyJobs.class);
	private static final String[] LOCATIONS = {"Remote", "Remote - US"};
