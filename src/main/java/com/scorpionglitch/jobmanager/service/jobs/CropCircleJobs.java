...
@Service
@Configurable
public class CropCircleJobs {
	private static final String NAME = "Crop Circle";

	private static final String GREENHOUSE_BOARD_ID = "cropcircle";
	private static final Logger LOGGER = LoggerFactory.getLogger(CropCircleJobs.class);
	private static final String[] LOCATIONS = {"Anywhere"};
