...
@Service
@Configurable
public class Unity3DJobs {
	private static final String NAME = "Unity3D";

	private static final String GREENHOUSE_BOARD_ID = "unity3d";
	private static final Logger LOGGER = LoggerFactory.getLogger(Unity3DJobs.class);
	private static final String[] LOCATIONS = {"New York, NY, USA", "Remote, USA"};
