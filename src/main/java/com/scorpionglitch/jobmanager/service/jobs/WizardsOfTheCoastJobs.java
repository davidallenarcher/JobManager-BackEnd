...
@Service
@Configurable
public class WizardsOfTheCoastJobs {
	private static final String NAME = "Wizards of the Coast";

	private static final String GREENHOUSE_BOARD_ID = "wizardsofthecoast";
	private static final Logger LOGGER = LoggerFactory.getLogger(WizardsOfTheCoastJobs.class);
	private static final String[] LOCATIONS = {
			"Fully Remote", 
			"Raleigh, NC / Fully Remote", 
			"Austin, TX / Fully Remote", 
			"Renton, WA / Fully Remote"
		};
