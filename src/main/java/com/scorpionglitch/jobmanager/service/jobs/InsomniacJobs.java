...
@Service
@Configurable
public class InsomniacJobs {
	private static final String NAME = "Insomniac";

	private static final String GREENHOUSE_BOARD_ID = "insomniac";
	private static final Logger LOGGER = LoggerFactory.getLogger(InsomniacJobs.class);
	private static final String[] LOCATIONS = {"United States, Remote"};
